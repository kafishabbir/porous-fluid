...
run/build/algo_determine.o: src/algo/determine.h src/algo/determine.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/algo/determine.cpp -o run/build/algo_determine.o
	@echo "run/build/algo_determine.o created."


run/build/algo_utility.o: src/algo/utility.h src/algo/utility.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/algo/utility.cpp -o run/build/algo_utility.o
	@echo "run/build/algo_utility.o created."


run/build/config_file_incongen.o: src/config_file/incongen.h src/config_file/incongen.cpp src/dst/head.h src/global/head.h
...
run/build/config_file_simulation.o: src/config_file/simulation.h src/config_file/simulation.cpp src/dst/head.h src/global/head.h
...
run/build/incongen_tlength.o: src/incongen/tlength.h src/incongen/tlength.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/incongen/tlength.cpp -o run/build/incongen_tlength.o
	@echo "run/build/incongen_tlength.o created."


run/build/incongen_tmns.o: src/incongen/tmns.h src/incongen/tmns.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/incongen/tmns.cpp -o run/build/incongen_tmns.o
	@echo "run/build/incongen_tmns.o created."


run/build/incongen_tradius.o: src/incongen/tradius.h src/incongen/tradius.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/incongen/tradius.cpp -o run/build/incongen_tradius.o
	@echo "run/build/incongen_tradius.o created."


run/build/io_cmdprint.o: src/io/cmdprint.h src/io/cmdprint.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/io/cmdprint.cpp -o run/build/io_cmdprint.o
	@echo "run/build/io_cmdprint.o created."


run/build/io_cmdread.o: src/io/cmdread.h src/io/cmdread.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/io/cmdread.cpp -o run/build/io_cmdread.o
	@echo "run/build/io_cmdread.o created."


run/build/io_fileplot.o: src/io/fileplot.h src/io/fileplot.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/io/fileplot.cpp -o run/build/io_fileplot.o
	@echo "run/build/io_fileplot.o created."


run/build/io_fileread.o: src/io/fileread.h src/io/fileread.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/io/fileread.cpp -o run/build/io_fileread.o
	@echo "run/build/io_fileread.o created."


run/build/io_filewrite.o: src/io/filewrite.h src/io/filewrite.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/io/filewrite.cpp -o run/build/io_filewrite.o
	@echo "run/build/io_filewrite.o created."


run/build/math_gausslinear.o: src/math/gausslinear.h src/math/gausslinear.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/math/gausslinear.cpp -o run/build/math_gausslinear.o
	@echo "run/build/math_gausslinear.o created."


run/build/math_random.o: src/math/random.h src/math/random.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/math/random.cpp -o run/build/math_random.o
	@echo "run/build/math_random.o created."


run/build/measure_measure.o: src/measure/measure.h src/measure/measure.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/measure/measure.cpp -o run/build/measure_measure.o
	@echo "run/build/measure_measure.o created."


run/build/network_dimension.o: src/network/dimension.h src/network/dimension.cpp src/dst/head.h src/global/head.h
...
run/build/network_mns.o: src/network/mns.h src/network/mns.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/network/mns.cpp -o run/build/network_mns.o
	@echo "run/build/network_mns.o created."


run/build/simulate_manager.o: src/simulate/manager.h src/simulate/manager.cpp src/dst/head.h src/global/head.h
	g++ -c -Wall -std=c++17 -Isrc/ src/simulate/manager.cpp -o run/build/simulate_manager.o
	@echo "run/build/simulate_manager.o created."


run/build/smlsteps_01pressure.o: src/smlsteps/01pressure.h src/smlsteps/01pressure.cpp src/dst/head.h src/global/head.h
...
run/build/smlsteps_02velocity.o: src/smlsteps/02velocity.h src/smlsteps/02velocity.cpp src/dst/head.h src/global/head.h
...
run/build/smlsteps_03timestep.o: src/smlsteps/03timestep.h src/smlsteps/03timestep.cpp src/dst/head.h src/global/head.h
...
run/build/smlsteps_04displacement.o: src/smlsteps/04displacement.h src/smlsteps/04displacement.cpp src/dst/head.h src/global/head.h
